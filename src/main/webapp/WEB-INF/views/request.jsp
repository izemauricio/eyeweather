...
<script type="text/javascript">
	...
	function createAllList(json) {
		...
		json.forEach(function(val, i) {
			...
			if (val.address.status == "ZERO_RESULTS") {
				return;
			}
			...
			var address = val.address.results[0].formatted_address;
			var b_lat = val.weather.location.latitude;
			var b_lon = val.weather.location.longitude;
			var b_time = val.dateString;
			var b_wind = val.weather.measure.wind;
			var b_temp = val.weather.measure.temp;
			var b_relh = val.weather.measure.relh;
			var weat = val.weather.measure.weat;
			var fore = val.weather.data.forecast[0];
			...
			var cardBody = "Coordinates: (" + b_lat + "," + b_lon + ")<br>Time: " + b_time + "<br>Wind: " + b_wind + " Temperature: " + b_temp + " Humidity: " + b_relh + "<br>Current: " + weat + "<br>Forecast: " + fore;
         ...
         <div class="col-md-12">
            <form class="form-inline" role="form" method="get" action="#">
               <div class="form-group">
                  <input style="border-radius: 0px" name="lat" id="lat" type="text" class="form-control" placeholder="LATITUDE" autofocus>
               </div>
               <div class="form-group">
                  <input style="border-radius: 0px" name="lon" id="lon" type="text" class="form-control" placeholder="LONGITUDE">
               </div>
               <input type="hidden" id="hiddenuserid" value="${user.id}">
               <button style="border-radius: 0px" type="button" class="btn btn-success" onClick="post_json()">Get card!</button>
            </form>
         </div>
      </div>
            ...
            <div class="panel panel-default">
               <div class="panel-heading clearfix">
                  ...
                  <div class="btn-group pull-right">
                     <input type="hidden" class="hiddenweatherid" id="hiddenweatherid" value=""> <a class="btn btn-xs btn-danger" href="#">x</a>
                  </div>
               </div>
